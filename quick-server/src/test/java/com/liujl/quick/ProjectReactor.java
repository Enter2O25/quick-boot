...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.liujl.boot";
    private static final String ARTIFACT_ID = "quick";
    private static final String PACKAGE_NAME = "com.liujl.quick";
    private static final String TITLE = "QuickBoot 管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.liujl.boot";
        String artifactIdNew = "quick";
        String packageNameNew = "com.liujl.quick";
        String titleNew = "QuickBoot 管理系统";

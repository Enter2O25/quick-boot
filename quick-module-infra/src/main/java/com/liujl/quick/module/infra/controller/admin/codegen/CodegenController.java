package com.liujl.quick.module.infra.controller.admin.codegen;
...
import com.liujl.quick.module.infra.controller.admin.codegen.vo.CodegenDetailRespVO;
import com.liujl.quick.module.infra.controller.admin.codegen.vo.CodegenPreviewRespVO;
...
import com.liujl.quick.module.infra.controller.admin.codegen.vo.table.CodegenTableRespVO;
import com.liujl.quick.module.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import com.liujl.quick.module.infra.convert.codegen.CodegenConvert;
...
import com.liujl.quick.module.infra.service.codegen.CodegenService;
...
import static com.liujl.quick.framework.security.core.util.SecurityFrameworkUtils.getLoginUserNickname;
import static com.liujl.quick.module.infra.framework.file.core.utils.FileTypeUtils.writeAttachment;
...
public class CodegenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "name", description = "表名，模糊匹配", example = "quick"),
            @Parameter(name = "comment", description = "描述，模糊匹配", example = "quick")
    })

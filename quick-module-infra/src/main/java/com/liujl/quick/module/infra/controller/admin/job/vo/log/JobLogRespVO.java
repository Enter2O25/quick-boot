package com.liujl.quick.module.infra.controller.admin.job.vo.log;
...
import com.liujl.quick.module.infra.enums.DictTypeConstants;
...
public class JobLogRespVO {
    ...
    @Schema(description = "处理器的参数", example = "quick")

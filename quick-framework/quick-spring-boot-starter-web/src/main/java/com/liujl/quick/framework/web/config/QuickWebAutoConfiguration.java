package com.liujl.quick.framework.web.config;
...
import com.liujl.quick.framework.web.core.filter.CacheRequestBodyFilter;
import com.liujl.quick.framework.web.core.filter.DemoFilter;
import com.liujl.quick.framework.web.core.handler.GlobalExceptionHandler;
import com.liujl.quick.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class QuickWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "quick.demo", havingValue = "true")

package com.liujl.quick.framework.ratelimiter.config;

import com.liujl.quick.framework.ratelimiter.core.aop.RateLimiterAspect;
import com.liujl.quick.framework.ratelimiter.core.keyresolver.RateLimiterKeyResolver;
import com.liujl.quick.framework.ratelimiter.core.keyresolver.impl.*;
import com.liujl.quick.framework.ratelimiter.core.redis.RateLimiterRedisDAO;
...
public class QuickRateLimiterConfiguration {

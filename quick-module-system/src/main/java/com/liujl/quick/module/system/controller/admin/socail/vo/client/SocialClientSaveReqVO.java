package com.liujl.quick.module.system.controller.admin.socail.vo.client;
...
import com.liujl.quick.framework.common.validation.InEnum;
...
public class SocialClientSaveReqVO {
    ...
    @Schema(description = "应用名", requiredMode = Schema.RequiredMode.REQUIRED, example = "quick商城")

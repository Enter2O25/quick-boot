package com.liujl.quick.module.system.service.social;
...
import com.liujl.quick.framework.common.util.cache.CacheUtils;
import com.liujl.quick.framework.common.util.http.HttpUtils;
import com.liujl.quick.framework.common.util.object.BeanUtils;
import com.liujl.quick.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import com.liujl.quick.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
import com.liujl.quick.module.system.api.social.dto.SocialWxaOrderUploadShippingInfoReqDTO;
import com.liujl.quick.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import com.liujl.quick.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import com.liujl.quick.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import com.liujl.quick.module.system.dal.dataobject.social.SocialClientDO;
import com.liujl.quick.module.system.dal.mysql.social.SocialClientMapper;
import com.liujl.quick.module.system.dal.redis.RedisKeyConstants;
import com.liujl.quick.module.system.enums.social.SocialTypeEnum;
import com.liujl.quick.module.system.framework.justauth.core.AuthRequestFactory;
...
import static com.liujl.quick.framework.common.util.collection.MapUtils.findAndThen;
import static com.liujl.quick.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static com.liujl.quick.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
import static com.liujl.quick.framework.common.util.json.JsonUtils.toJsonString;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${quick.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${quick.wxa-subscribe-message.miniprogram-state:formal}")
    ...
    public void uploadWxaOrderShippingInfo(Integer userType, SocialWxaOrderUploadShippingInfoReqDTO reqDTO) {
        ...
        // 对应 ISSUE：https://gitee.com/zhijiantianya/quick-cloud/pulls/230
